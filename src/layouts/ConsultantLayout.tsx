  ...
  const menuItems = [
    {
      key: '/consultant/hub',
      icon: <Globe size={22} />,
      label: <Link to="/consultant/hub" className="text-[14px] font-medium transition-colors">Multi-State Hub</Link>,
    },
    {
      key: '/consultant/state',
      icon: <Search size={22} />,
      label: <Link to="/consultant/state" className="text-[14px] font-medium transition-colors">State Deep Dive</Link>,
    },
    {
      key: '/consultant/geospatial',
      icon: <Map size={22} />,
      label: <Link to="/consultant/geospatial" className="text-[14px] font-medium transition-colors">Geospatial Intel</Link>,
    },
    {
    ...
    },
    {
      ...
      label: <Link to="/consultant/support" className="text-[14px] font-medium transition-colors">Support</Link>,
    },
  ]
        ...
        <Layout className="main-content-layout">
            ...
            <div className="flex items-center gap-6 shrink-0">
              <div className="hidden sm:flex flex-col items-end gap-1.5 border-r border-white/10 pr-6 mr-6">
                <span className="text-[10px] font-black text-white uppercase tracking-tighter opacity-40 leading-none">Consultant Access</span>
                <span className="text-xs text-emerald-400 font-black uppercase tracking-widest italic leading-none">Master Analyst</span>
              </div>
